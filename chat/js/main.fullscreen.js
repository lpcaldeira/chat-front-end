...
! function(e, t) {
    ...
    function n(e) {
        ...
        if (e && e.nodeName && "TEXTAREA" === e.nodeName && !r.has(e)) {
            var f = null,
                c = null,
                v = e.clientWidth,
                p = function() { e.clientWidth !== v && i() },
                h = function(t) { window.removeEventListener("resize", p, !1), e.removeEventListener("input", i, !1), e.removeEventListener("keyup", i, !1), e.removeEventListener("autosize:destroy", h, !1), e.removeEventListener("autosize:update", i, !1), r["delete"](e), Object.keys(t).forEach(function(n) { e.style[n] = t[n] }) }.bind(e, { height: e.style.height, resize: e.style.resize, overflowY: e.style.overflowY, overflowX: e.style.overflowX, wordWrap: e.style.wordWrap });
    ...
    var r = "function" == typeof Set ? new Set : function() { var e = []; return { has: function(t) { return Boolean(e.indexOf(t) > -1) }, add: function(t) { e.push(t) }, "delete": function(t) { e.splice(e.indexOf(t), 1) } } }(),
        d = null;
...
! function(e) {
    e.fn.extend({
        slimScroll: function(i) {
            var s = { width: "auto", height: "100%", size: "7px", color: "#000", position: "right", distance: "1px", start: "top", opacity: 1, alwaysVisible: !1, disableFadeOut: !1, railVisible: !1, railColor: "#333", railOpacity: .2, railDraggable: !0, railClass: "slimScrollRail", barClass: "slimScrollBar", wrapperClass: "slimScrollDiv", allowPageScroll: !1, wheelStep: 20, touchScrollStep: 200, borderRadius: "7px", railBorderRadius: "7px" },
                o = e.extend(s, i);
            return this.each(function() {
                ...
                function a(e) { window.addEventListener ? (e.addEventListener("DOMMouseScroll", s, !1), e.addEventListener("mousewheel", s, !1)) : document.attachEvent("onmousewheel", s) }
                ...
                function c() { o.alwaysVisible || (p = setTimeout(function() { o.disableFadeOut && h || u || d || (D.fadeOut("slow"), R.fadeOut("slow")) }, 1e3)) }
                ...
                if (x.parent().hasClass(o.wrapperClass)) {
                    ...
                    var E = e(w).addClass(o.wrapperClass).css({ position: "static", overflow: "hidden", width: o.width, height: o.height });
                    x.css({ overflow: "hidden", width: o.width, height: o.height });
                    var R = e(w).addClass(o.railClass).css({ width: o.size, height: "100%", position: "absolute", top: 0, display: o.alwaysVisible && o.railVisible ? "block" : "none", "border-radius": o.railBorderRadius, background: o.railColor, opacity: o.railOpacity, zIndex: 90 }),
                        D = e(w).addClass(o.barClass).css({ background: o.color, width: o.size, position: "absolute", top: 0, opacity: o.opacity, display: o.alwaysVisible ? "block" : "none", "border-radius": o.borderRadius, BorderRadius: o.borderRadius, MozBorderRadius: o.borderRadius, WebkitBorderRadius: o.borderRadius, zIndex: 99 }),
                        M = "right" == o.position ? { right: o.distance } : { left: o.distance };
                    R.css(M), D.css(M), x.wrap(E), x.parent().append(D), x.parent().append(R), o.railDraggable && D.bind("mousedown", function(i) { var s = e(document); return d = !0, t = parseFloat(D.css("top")), pageY = i.pageY, s.bind("mousemove.slimscroll", function(e) { currTop = t + e.pageY - pageY, D.css("top", currTop), r(0, D.position().top, !1) }), s.bind("mouseup.slimscroll", function(e) { d = !1, c(), s.unbind(".slimscroll") }), !1 }).bind("selectstart.slimscroll", function(e) { return e.stopPropagation(), e.preventDefault(), !1 }), R.hover(function() { n() }, function() { c() }), D.hover(function() { u = !0 }, function() { u = !1 }), x.hover(function() { h = !0, n(), c() }, function() { h = !1, c() }), x.bind("touchstart", function(e, t) { e.originalEvent.touches.length && (g = e.originalEvent.touches[0].pageY) }), x.bind("touchmove", function(e) {
                    ...
                    }), l(), "bottom" === o.start ? (D.css({ top: x.outerHeight() - D.outerHeight() }), r(0, !0)) : "top" !== o.start && (r(e(o.start).position().top, null, !0), o.alwaysVisible || D.hide()), a(this)
                }
            }), this
        }
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $("#mensagemTextarea").keyup(function(e) {
            if ($(this).val().length > 0) {
                $("#sb-chat-btn-submit").removeClass('disabled');
                $("#sb-chat-btn-submit").addClass('enabled');
            } else {
                $("#sb-chat-btn-submit").removeClass('enabled');
                $("#sb-chat-btn-submit").addClass('disabled');
            }
        ...
        if (!real_time) {
            setInterval(function() { sb_update_view(); }, 5000);
            real_time = true;
        }

        sb_add_message('iniciar');
    });
        ...
        $.ajax({
            ...
            complete: function(response) {
                ...
                response = {
                    isServer: false,
                    isCarousel: false,
                    isButtons: opcao == 'iniciar' ? true : false,
                    ...
                    buttons: ['CHATBOT', 'SMS', 'EMAIL', 'Outras opções', 'CHATBOT', 'SMS', 'EMAIL', 'Outras opções', 'CHATBOT', 'SMS', 'EMAIL', 'Outras opções', 'CHATBOT', 'SMS', 'EMAIL', 'Outras opções', 'CHATBOT', 'SMS', 'EMAIL', 'Outras opções', ]
                }
    ...
    function sb_show_buttons(response) {
        if (!isEmpty(response) && !isEmpty(response.buttons)) {
            var conversa =
                ...
                '<div class="col-sm-12 col-md-12" style="transform: translate3d(0px, 0px, 0px);">';

            // Conteúdo
            for (var texto in response.buttons) {
                conversa += '<button class="button action-text" onclick="sb_add_message(\'' + response.buttons[texto] + '\')">' + response.buttons[texto] + '</button>';
            }
            conversa += '</div></div>';
    ...
    function sb_show_carousel(response) {
        if (!isEmpty(response) && !isEmpty(response.carousel)) {
            ...
            var conversa = '<div class="owl-carousel owl-theme ' + randomico + '" style="margin-bottom: 20px; width: 100% !important; float: left;">';
    ...
    function sb_update_view() {
        // Atualiza as mensagens na tela
        $(".sb-list,.sb-chat-list").each(function() {
            var t = this;
            //console.log(!isEmpty($(t).attr("data-scroll")), isChat);
            if (!isEmpty($(t).attr("data-scroll")) || isChat) {
                var _height = isEmpty($(t).attr("data-height")) ? 0 : $(t).attr("data-height");
                var offset = isEmpty($(t).attr("data-offset")) ? 0 : parseInt($(t).attr("data-offset"));
                if (isChat) _height = 300;
                if (isEmpty(offset)) offset = 0;
                if (isWpAdmin) offset += 32;
                //console.log(wh, offset);
                _height = wh - offset;
                if (_height > 200) {
                    setTimeout(function() {
                        var chat = $(".sb-chat");
                        isScrollBox = true;
                        var ch = $(chat).height();
                        //console.log(ww, wh, ch, $(".sb-chat-logo").outerHeight());
                        //_height = wh - $(".sb-chat-logo").outerHeight() - 100;
                        _height = wh - 160;
